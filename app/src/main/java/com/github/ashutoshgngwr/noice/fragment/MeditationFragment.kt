...
import com.github.ashutoshgngwr.noice.databinding.MedSoundListItemBinding
import com.github.ashutoshgngwr.noice.databinding.MeditationFragmentBinding
...
import com.github.ashutoshgngwr.noice.model.MedSound
...
class MeditationFragment : Fragment() {
  ...
  private val dataSet by lazy {
    arrayListOf<SoundListItem>().also { list ->
      ...
      MedSound.MEDITATIONLIBRARY.toSortedMap(
        compareBy(
          { getString(MedSound.get(it).displayGroupResID) },
          { getString(MedSound.get(it).titleResID) }
        )
      ).forEach {
        ...
        list.add(SoundListItem(R.layout.med_sound_list_item, it.key))
      }
    }
  }
  ...
  override fun onCreateView(
    ...
    binding = MeditationFragmentBinding.inflate(inflater, container, false)
    return binding.root
  }
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    analyticsProvider.setCurrentScreen("meditation" +
  ...
  private inner class SoundListAdapter(private val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
      return when (viewType) {
        ...
        R.layout.med_sound_list_item -> SoundListItemViewHolder(
          MedSoundListItemBinding.inflate(
            layoutInflater,
            parent,
            false
          )
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
      ...
      val sound = MedSound.get(soundKey)
  ...
  inner class SoundListItemViewHolder(val binding: MedSoundListItemBinding) :
    RecyclerView.ViewHolder(binding.root) {
    ...
    private fun showSoundControlDialog() {
      ...
      val sound = MedSound.get(listItem.data)
