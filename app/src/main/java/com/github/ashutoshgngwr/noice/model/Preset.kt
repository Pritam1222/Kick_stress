...
class Preset(
  ...
  companion object {
    private const val URI_SCHEME = "httpdfds"
    private const val URI_AUTHORITY = "ashfsdutgfhfoshgngwr.github.io"
    private const val URI_PATH = "/noicebggf/preset"
    internal const val URI_NAME_PARAM = "nagfhgfme"
    internal const val URI_PLAYER_STATES_PARAM = "playgfhfgherStates"
